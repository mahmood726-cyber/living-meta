        # Living Meta: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/living-meta.git

        ## Objective

        LivingMeta is an automated living meta-analysis platform that monitors literature databases, triggers re-analyses on new evidence, and produces continuously updated synthesis outputs.
        ...
        - Code: https://github.com/mahmood726-cyber/living-meta.git
        - Dashboard: https://mahmood726-cyber.github.io/living-meta/
